...
class Problem:
    ...
    def open_cpp(self,tp):
        file_management.open_file(string_manip.path_win_q(path_maker.path_problem_cpp(self,tp)))
    def open_cbp(self,tp):
        file_management.open_file(string_manip.path_win_q(path_maker.path_problem_cbp(self,tp)))
    ...
    def stress(self,stress_cnt):
        ...
        if(file_management.read_file(string_manip.path_win(path_maker.path_utils_verdict(self)))==strings.wa):
            test_in=file_management.file_read(string_manip.path_win(path_maker.path_io_txt(self,strings.gen)))
            test_out=file_management.file_read(string_manip.path_win(path_maker.path_io_txt(self,strings.bf)))
