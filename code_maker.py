...
def code_stress(self):
    return (r'path_code=${1}''\n'
            ...
            r'    if((${?}==124))''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BPurple}TLE${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            ...
            r'    elif [[ -s "${path_utils}/${err_main}" ]]''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BYellow}RTE${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            ...
            r'    if((${?}==124))''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BPurple}TLE: bf${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
            ...
            r'    then''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BYellow}RTE: bf${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
            ...
            r'    then''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BGreen}OK${NoColor}"''\n'
            ...
            r'        fi''\n'
            r'    else''\n'
            r'        printf "\r${BWhite}[Stress #${i}] ${BRed}WA${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
...
def code_check(self):
    return (r'path_code=${1}''\n'
            ...
            r'    if((${?}==124))''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BPurple}TLE: gen${NoColor}\n"''\n'
            r'        break''\n'
            r'    elif [[ -s "${path_utils}/${err_gen}" ]]''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BYellow}RTE: gen${NoColor}\n"''\n'
            r'        break''\n'
            r'    fi''\n'
            r'    { timeout --foreground ${tl} "./${main}" < "${path_io}/${out_gen}" > "${path_io}/${out_main}"; } &> "${path_utils}/${err_main}"''\n'
            r'    if((${?}==124))''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BPurple}TLE${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "TLE" > "${path_utils}/${out_verdict}"''\n'
            r'        break''\n'
            r'    elif [[ -s "${path_utils}/${err_main}" ]]''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BYellow}RTE${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "RTE" > "${path_utils}/${out_verdict}"''\n'
            r'        break''\n'
            ...
            r'    if((${?}==124))''\n'
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BPurple}TLE: ch${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
            ...
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BYellow}RTE: ch${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
            ...
            r'    then''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BGreen}OK${NoColor}"''\n'
            r'        printf "OK" > "${path_utils}/${out_verdict}"''\n'
            r'        if((i==${check_cnt}))''\n'
            r'        then''\n'
            r'            printf "${NoColor}\n"''\n'
            r'        fi''\n'
            r'    else''\n'
            r'        printf "\r${BWhite}[Check #${i}] ${BRed}WA${NoColor}\n"''\n'
            r'        printf "${BBlue}Input${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_gen}")"''\n'
            r'        printf "${BBlue}Received${NoColor}\n"''\n'
            r'		echo "$(<"${path_io}/${out_main}")"''\n'
