...
def code_run(self):
    return ('# $1 -> io_cnt\n'
            ...
            'BPurple=\'\\033[1;35m\'\n'
            'BWhite=\'\\033[1;37m\'\n'
            'if ! g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_main))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_main))+'\n'
            'then\n'
...
def code_stress(self):
    return ('# $1 -> stress_cnt\n'
            ...
            '    exit 0\n'
            'fi\n'
            'if ! g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_bf))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_bf))+'\n'
            'then\n'
            '    printf "${BWhite}CE: bf${NoColor}\\n"\n'
            '    exit 0\n'
            'fi\n'
            'if ! g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_gen))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_gen))+'\n'
            'then\n'
...
def code_check(self):
    return ('# $1 -> check_cnt\n'
            ...
            '    exit 0\n'
            'fi\n'
            'if ! g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_ch))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_ch))+'\n'
            'then\n'
