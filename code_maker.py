...
def code_run(self):
    temp=('# $1 -> io_cnt\n'
          ...
          'BPurple=\'\\033[1;35m\'\n'
          'BWhite=\'\\033[1;37m\'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_main))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_main))+'\n'
          'for((i=1;i<=${1};i++))\n'
          'do\n'
...
def code_stress(self):
    temp=('# $1 -> stress_cnt\n'
          ...
          'BWhite=\'\\033[1;37m\'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_main))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_main))+'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_bf))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_bf))+'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_gen))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_gen))+'\n'
          'for((i=1;i<=${1};i++))\n'
          'do\n'
...
def code_check(self):
    temp=('# $1 -> check_cnt\n'
          ...
          'BWhite=\'\\033[1;37m\'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_main))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_main))+'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_ch))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_ch))+'\n'
          'g++ -Wall -Wextra -Wshadow -std=c++17 '+string_manip.path_wsl_q(path_maker.path_problem_cpp(self,strings.tp_gen))+' -o '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_gen))+'\n'
          'for((i=1;i<=${1};i++))\n'
          'do\n'
          '    timeout ${2} '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_gen))+' > '+string_manip.path_wsl_q(path_maker.path_io_txt(self,strings.tp_gen))+'\n'
