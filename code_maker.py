...
def code_stress(self):
    return ('# $1 -> stress_cnt\n'
            ...
            '        printf "TLE" > verdict.txt\n'
            '        break\n'
            '    elif [[ -s '+string_manip.path_wsl_q(path_maker.path_utils_err(self,strings.tp_main))+' ]]\n'
            '    then\n'
            '        printf "\\r${BWhite}[Stress #${i}] ${BYellow}RTE${NoColor}\\n"\n'
            '        printf "RTE" > verdict.txt\n'
            '        break\n'
            '    fi\n'
            ...
            '        printf "WA" > verdict.txt\n'
            '        break\n'
            '    fi\n'
            'done\n')

def code_check(self):
    return ('# $1 -> '+string_manip.path_wsl_q(path_maker.path_problem_exe(self,strings.tp_ch))+'eck_cnt\n'
            '# $2 -> tl\n'
            'NoColor=\'\\033[0m\'\n'
            'BRed=\'\\033[1;31m\'\n'
            'BGreen=\'\\033[1;32m\'\n'
            ...
            '        cat '+string_manip.path_wsl_q(path_maker.path_io_txt(self,strings.tp_ch))+'\n'
            '        printf "WA" > verdict.txt\n'
            '        break\n'
            '    fi\n'
            'done\n')
